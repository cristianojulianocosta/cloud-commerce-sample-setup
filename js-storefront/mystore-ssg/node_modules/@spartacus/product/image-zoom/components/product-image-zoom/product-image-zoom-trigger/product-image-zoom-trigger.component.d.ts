...
export declare class ProductImageZoomTriggerComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductImageZoomTriggerComponent, "cx-product-image-zoom-trigger", never, { "galleryIndex": { "alias": "galleryIndex"; "required": false; }; "expandImage": { "alias": "expandImage"; "required": false; }; }, { "dialogClose": "dialogClose"; }, never, never, false, never>;
}
