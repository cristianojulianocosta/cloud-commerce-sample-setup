...
export declare class ProductImageZoomDialogComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductImageZoomDialogComponent, "cx-product-image-zoom-dialog", never, { "galleryIndex": { "alias": "galleryIndex"; "required": false; }; }, {}, never, never, false, never>;
}
