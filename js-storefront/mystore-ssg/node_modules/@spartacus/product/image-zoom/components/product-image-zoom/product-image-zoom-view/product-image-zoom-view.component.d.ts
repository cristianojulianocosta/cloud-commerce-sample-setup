...
export declare class ProductImageZoomViewComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductImageZoomViewComponent, "cx-product-image-zoom-view", never, { "galleryIndex": { "alias": "galleryIndex"; "required": false; }; }, {}, never, never, false, never>;
}
