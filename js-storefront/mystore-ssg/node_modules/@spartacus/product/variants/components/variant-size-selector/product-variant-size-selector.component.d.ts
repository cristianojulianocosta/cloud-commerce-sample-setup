...
export declare class ProductVariantSizeSelectorComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductVariantSizeSelectorComponent, "cx-product-variant-size-selector", never, { "product": { "alias": "product"; "required": false; }; "variants": { "alias": "variants"; "required": false; }; }, {}, never, never, false, never>;
}
