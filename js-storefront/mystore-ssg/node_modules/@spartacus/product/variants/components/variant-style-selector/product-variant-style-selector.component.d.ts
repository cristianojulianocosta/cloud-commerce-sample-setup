...
export declare class ProductVariantStyleSelectorComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductVariantStyleSelectorComponent, "cx-product-variant-style-selector", never, { "variants": { "alias": "variants"; "required": false; }; }, {}, never, never, false, never>;
}
