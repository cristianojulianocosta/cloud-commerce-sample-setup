...
export declare class ProductVariantColorSelectorComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductVariantColorSelectorComponent, "cx-product-variant-color-selector", never, { "product": { "alias": "product"; "required": false; }; "variants": { "alias": "variants"; "required": false; }; }, {}, never, never, false, never>;
}
