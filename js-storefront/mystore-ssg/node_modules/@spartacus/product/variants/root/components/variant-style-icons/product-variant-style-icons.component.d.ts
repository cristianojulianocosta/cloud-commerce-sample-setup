...
export declare class ProductVariantStyleIconsComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductVariantStyleIconsComponent, "cx-variant-style-icons", never, { "variants": { "alias": "variants"; "required": false; }; }, {}, never, never, false, never>;
}
