...
export declare class FeatureLevelDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<FeatureLevelDirective, "[cxFeatureLevel]", never, { "cxFeatureLevel": { "alias": "cxFeatureLevel"; "required": false; }; }, {}, never, never, false, never>;
}
