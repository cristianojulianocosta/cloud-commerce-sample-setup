...
export class CmsComponentConnector {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CmsComponentConnector, deps: [{ token: i1.CmsStructureConfigService }, { token: i2.CmsComponentAdapter }, { token: i3.CmsConfig }], target: i0.ɵɵFactoryTarget.Injectable }); }
