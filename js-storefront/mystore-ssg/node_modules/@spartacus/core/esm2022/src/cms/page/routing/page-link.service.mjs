...
export class PageLinkService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: PageLinkService, deps: [{ token: i1.PageMetaConfig }, { token: i2.WindowRef }], target: i0.ɵɵFactoryTarget.Injectable }); }
