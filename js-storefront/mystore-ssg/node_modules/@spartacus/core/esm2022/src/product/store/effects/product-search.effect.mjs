...
export class ProductsSearchEffects {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: ProductsSearchEffects, deps: [{ token: i1.Actions }, { token: i2.ProductSearchConnector }], target: i0.ɵɵFactoryTarget.Injectable }); }
