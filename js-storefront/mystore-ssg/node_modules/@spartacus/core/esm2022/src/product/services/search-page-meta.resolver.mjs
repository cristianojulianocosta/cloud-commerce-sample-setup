...
export class SearchPageMetaResolver extends PageMetaResolver {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: SearchPageMetaResolver, deps: [{ token: i1.RoutingService }, { token: i2.ProductSearchService }, { token: i3.TranslationService }, { token: i4.BasePageMetaResolver }], target: i0.ɵɵFactoryTarget.Injectable }); }
