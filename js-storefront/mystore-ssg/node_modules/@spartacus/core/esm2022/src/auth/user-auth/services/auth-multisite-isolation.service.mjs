...
export class AuthMultisiteIsolationService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AuthMultisiteIsolationService, deps: [{ token: i1.BaseSiteService }], target: i0.ɵɵFactoryTarget.Injectable }); }
