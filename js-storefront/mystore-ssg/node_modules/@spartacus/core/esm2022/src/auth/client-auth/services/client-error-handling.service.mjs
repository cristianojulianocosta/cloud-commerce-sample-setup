...
export class ClientErrorHandlingService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: ClientErrorHandlingService, deps: [{ token: i1.ClientTokenService }], target: i0.ɵɵFactoryTarget.Injectable }); }
