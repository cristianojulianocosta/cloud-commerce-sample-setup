...
export class CxDatePipe extends DatePipe {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CxDatePipe, deps: [{ token: i1.LanguageService }], target: i0.ɵɵFactoryTarget.Pipe }); }
