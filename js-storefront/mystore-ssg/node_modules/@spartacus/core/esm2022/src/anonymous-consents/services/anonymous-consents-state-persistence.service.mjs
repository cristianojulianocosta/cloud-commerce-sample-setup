...
export class AnonymousConsentsStatePersistenceService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AnonymousConsentsStatePersistenceService, deps: [{ token: i1.StatePersistenceService }, { token: i2.Store }, { token: i3.AnonymousConsentsService }], target: i0.ɵɵFactoryTarget.Injectable }); }
