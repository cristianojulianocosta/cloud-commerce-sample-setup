...
export class AnonymousConsentsService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AnonymousConsentsService, deps: [{ token: i1.Store }, { token: i2.AuthService }], target: i0.ɵɵFactoryTarget.Injectable }); }
