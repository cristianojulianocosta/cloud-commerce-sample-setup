...
export class SiteContextUrlSerializer extends DefaultUrlSerializer {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: SiteContextUrlSerializer, deps: [{ token: i1.SiteContextParamsService }], target: i0.ɵɵFactoryTarget.Injectable }); }
