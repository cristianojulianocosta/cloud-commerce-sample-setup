...
export class CurrencyInitializer {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CurrencyInitializer, deps: [{ token: i1.CurrencyService }, { token: i2.CurrencyStatePersistenceService }, { token: i3.ConfigInitializerService }], target: i0.ɵɵFactoryTarget.Injectable }); }
