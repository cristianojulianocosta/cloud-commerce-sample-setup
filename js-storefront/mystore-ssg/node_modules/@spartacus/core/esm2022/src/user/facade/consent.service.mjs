...
export class ConsentService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: ConsentService, deps: [{ token: i1.AnonymousConsentsService }, { token: i2.UserConsentService }], target: i0.ɵɵFactoryTarget.Injectable }); }
