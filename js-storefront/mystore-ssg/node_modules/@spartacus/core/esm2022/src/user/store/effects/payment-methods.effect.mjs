...
export class UserPaymentMethodsEffects {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: UserPaymentMethodsEffects, deps: [{ token: i1.Actions }, { token: i2.UserPaymentConnector }, { token: i3.GlobalMessageService }], target: i0.ɵɵFactoryTarget.Injectable }); }
