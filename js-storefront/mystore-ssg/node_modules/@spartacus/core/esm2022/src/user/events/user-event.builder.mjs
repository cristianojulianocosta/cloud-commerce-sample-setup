...
export class UserEventBuilder {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: UserEventBuilder, deps: [{ token: i1.StateEventService }], target: i0.ɵɵFactoryTarget.Injectable }); }
