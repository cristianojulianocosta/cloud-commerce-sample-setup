...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: DatePickerComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.DatePickerService }], propDecorators: { control: [{
                type: Input
            }], min: [{
                type: Input
            }], max: [{
