...
export declare class SearchBoxComponent implements OnInit, OnDestroy {
    ...
    readonly searchBoxOutlets: typeof SearchBoxOutlets;
    readonly searchBoxFeatures: typeof SearchBoxFeatures;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SearchBoxComponent, "cx-searchbox", never, { "config": { "alias": "config"; "required": false; }; "queryText": { "alias": "queryText"; "required": false; }; }, {}, never, never, false, never>;
}
