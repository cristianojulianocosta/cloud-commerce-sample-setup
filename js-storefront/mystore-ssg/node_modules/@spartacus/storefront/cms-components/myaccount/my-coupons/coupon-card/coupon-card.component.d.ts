...
export declare class CouponCardComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CouponCardComponent, "cx-coupon-card", never, { "coupon": { "alias": "coupon"; "required": false; }; "couponSubscriptionLoading$": { "alias": "couponSubscriptionLoading$"; "required": false; }; }, { "notificationChanged": "notificationChanged"; }, never, never, false, never>;
}
