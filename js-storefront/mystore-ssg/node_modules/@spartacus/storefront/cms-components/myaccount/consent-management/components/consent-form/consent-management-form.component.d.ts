...
export declare class ConsentManagementFormComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConsentManagementFormComponent, "cx-consent-management-form", never, { "consentTemplate": { "alias": "consentTemplate"; "required": false; }; "requiredConsents": { "alias": "requiredConsents"; "required": false; }; "consent": { "alias": "consent"; "required": false; }; }, { "consentChanged": "consentChanged"; }, never, never, false, never>;
}
