...
export declare class ProductCarouselItemComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductCarouselItemComponent, "cx-product-carousel-item", never, { "item": { "alias": "item"; "required": false; }; }, {}, never, never, false, never>;
}
