...
export declare class FacetListComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FacetListComponent, "cx-facet-list", never, { "isDialog": { "alias": "isDialog"; "required": false; }; }, { "closeList": "closeList"; }, never, never, false, never>;
}
