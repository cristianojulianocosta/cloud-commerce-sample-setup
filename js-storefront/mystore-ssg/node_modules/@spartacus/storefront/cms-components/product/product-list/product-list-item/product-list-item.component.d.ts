...
export declare class ProductListItemComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductListItemComponent, "cx-product-list-item", never, { "product": { "alias": "product"; "required": false; }; }, {}, never, never, false, never>;
}
