...
export declare class ProductGridItemComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductGridItemComponent, "cx-product-grid-item", never, { "product": { "alias": "product"; "required": false; }; }, {}, never, never, false, never>;
}
