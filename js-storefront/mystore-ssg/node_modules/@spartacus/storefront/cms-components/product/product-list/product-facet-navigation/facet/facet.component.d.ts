...
export declare class FacetComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FacetComponent, "cx-facet", never, { "expandIcon": { "alias": "expandIcon"; "required": false; }; "collapseIcon": { "alias": "collapseIcon"; "required": false; }; "facet": { "alias": "facet"; "required": false; }; }, {}, never, never, false, never>;
}
