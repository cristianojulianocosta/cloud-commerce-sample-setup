...
export declare class ProductScrollComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductScrollComponent, "cx-product-scroll", never, { "setConfig": { "alias": "scrollConfig"; "required": false; }; "setModel": { "alias": "model"; "required": false; }; "setViewMode": { "alias": "inputViewMode"; "required": false; }; }, {}, never, never, false, never>;
}
