...
export declare class ProductViewComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductViewComponent, "cx-product-view", never, { "mode": { "alias": "mode"; "required": false; }; }, { "modeChange": "modeChange"; }, never, never, false, never>;
}
