...
export declare class MockIconComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MockIconComponent, "cx-icon,[cxIcon]", never, { "cxIcon": { "alias": "cxIcon"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, false, never>;
}
