import { ChangeDetectorRef, ComponentFactoryResolver, ComponentRef, ElementRef, EventEmitter, OnInit, Renderer2, TemplateRef, ViewContainerRef } from '@angular/core';
...
export declare class PopoverDirective implements OnInit {
    ...
    featureConfigService?: FeatureConfigService | null | undefined;
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PopoverDirective, "[cxPopover]", never, { "cxPopover": { "alias": "cxPopover"; "required": false; }; "cxPopoverOptions": { "alias": "cxPopoverOptions"; "required": false; }; }, { "openPopover": "openPopover"; "closePopover": "closePopover"; }, never, never, false, never>;
}
