import { EventEmitter, OnChanges, TrackByFunction } from '@angular/core';
...
export declare class MediaComponent implements OnChanges {
     ...
     */
    isMissing: boolean;
    protected trackByMedia: TrackByFunction<HTMLSourceElement>;
    protected isLegacy: any;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MediaComponent, "cx-media", never, { "container": { "alias": "container"; "required": false; }; "format": { "alias": "format"; "required": false; }; "alt": { "alias": "alt"; "required": false; }; "role": { "alias": "role"; "required": false; }; "loading": { "alias": "loading"; "required": false; }; }, { "loaded": "loaded"; }, never, never, false, never>;
}
