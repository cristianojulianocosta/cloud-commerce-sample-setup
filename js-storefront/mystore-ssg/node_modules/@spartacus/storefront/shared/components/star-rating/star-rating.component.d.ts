...
export declare class StarRatingComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StarRatingComponent, "cx-star-rating", never, { "disabled": { "alias": "disabled"; "required": false; }; "rating": { "alias": "rating"; "required": false; }; }, { "change": "change"; }, never, never, false, never>;
}
