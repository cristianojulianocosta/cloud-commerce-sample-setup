...
export declare class ViewComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ViewComponent, "cx-view", never, { "position": { "alias": "position"; "required": false; }; "hidden": { "alias": "hidden"; "required": false; }; }, { "hiddenChange": "hiddenChange"; }, never, ["*"], false, never>;
}
