...
export declare class FileUploadComponent implements ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FileUploadComponent, "cx-file-upload", never, { "accept": { "alias": "accept"; "required": false; }; "multiple": { "alias": "multiple"; "required": false; }; }, { "update": "update"; }, ["customButton"], ["*"], false, never>;
}
