...
export declare class PasswordVisibilityToggleComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PasswordVisibilityToggleComponent, "cx-password-visibility-toggle", never, { "inputElement": { "alias": "inputElement"; "required": false; }; }, {}, never, never, false, never>;
}
