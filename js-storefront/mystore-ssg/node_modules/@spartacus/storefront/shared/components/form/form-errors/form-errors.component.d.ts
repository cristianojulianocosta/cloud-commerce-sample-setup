...
export declare class FormErrorsComponent implements DoCheck {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FormErrorsComponent, "cx-form-errors", never, { "prefix": { "alias": "prefix"; "required": false; }; "translationParams": { "alias": "translationParams"; "required": false; }; "control": { "alias": "control"; "required": false; }; }, {}, never, never, false, never>;
}
