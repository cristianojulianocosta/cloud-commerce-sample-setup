...
export declare class DatePickerComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatePickerComponent, "cx-date-picker", never, { "control": { "alias": "control"; "required": false; }; "min": { "alias": "min"; "required": false; }; "max": { "alias": "max"; "required": false; }; "required": { "alias": "required"; "required": false; }; }, { "update": "update"; }, never, never, false, never>;
}
