...
export declare class TableComponent<T> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TableComponent<any>, "cx-table", never, { "structure": { "alias": "structure"; "required": false; }; "data": { "alias": "data"; "required": false; }; "i18nRoot": { "alias": "i18nRoot"; "required": false; }; "currentItem": { "alias": "currentItem"; "required": false; }; }, { "launch": "launch"; }, never, never, false, never>;
}
