...
export declare class OutletRefDirective implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<OutletRefDirective, "[cxOutletRef]", never, { "cxOutletRef": { "alias": "cxOutletRef"; "required": false; }; "cxOutletPos": { "alias": "cxOutletPos"; "required": false; }; }, {}, never, never, false, never>;
}
