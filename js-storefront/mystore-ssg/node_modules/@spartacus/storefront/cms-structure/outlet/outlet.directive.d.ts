...
export declare class OutletDirective<T = any> implements OnDestroy, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<OutletDirective<any>, "[cxOutlet]", never, { "cxOutlet": { "alias": "cxOutlet"; "required": false; }; "cxOutletContext": { "alias": "cxOutletContext"; "required": false; }; "cxOutletDefer": { "alias": "cxOutletDefer"; "required": false; }; "cxComponentRef": { "alias": "cxComponentRef"; "required": false; }; }, { "loaded": "loaded"; "cxComponentRefChange": "cxComponentRefChange"; }, never, never, false, never>;
}
