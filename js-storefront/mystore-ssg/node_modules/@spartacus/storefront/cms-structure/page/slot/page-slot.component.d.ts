...
export declare class PageSlotComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PageSlotComponent, "cx-page-slot,[cx-page-slot]", never, { "position": { "alias": "position"; "required": false; }; "class": { "alias": "class"; "required": false; }; "isPageFold": { "alias": "isPageFold"; "required": false; }; "hasComponents": { "alias": "hasComponents"; "required": false; }; }, {}, never, never, false, never>;
}
