...
export declare class ComponentWrapperDirective implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ComponentWrapperDirective, "[cxComponentWrapper]", never, { "cxComponentWrapper": { "alias": "cxComponentWrapper"; "required": false; }; }, { "cxComponentRef": "cxComponentRef"; }, never, never, false, never>;
}
