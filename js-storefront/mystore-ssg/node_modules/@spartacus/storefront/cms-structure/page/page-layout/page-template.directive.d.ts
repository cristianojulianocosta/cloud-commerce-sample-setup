...
export declare class PageTemplateDirective implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PageTemplateDirective, "[cxPageTemplateStyle]", never, { "setTemplate": { "alias": "cxPageTemplateStyle"; "required": false; }; }, {}, never, never, false, never>;
}
