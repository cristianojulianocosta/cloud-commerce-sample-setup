...
export class CartVoucherService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CartVoucherService, deps: [{ token: i1.Store }, { token: i2.ActiveCartFacade }, { token: i3.UserIdService }], target: i0.ɵɵFactoryTarget.Injectable }); }
