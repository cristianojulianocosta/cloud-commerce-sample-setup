...
export class SelectiveCartService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: SelectiveCartService, deps: [{ token: i1.UserProfileFacade }, { token: i2.MultiCartFacade }, { token: i3.BaseSiteService }, { token: i3.UserIdService }], target: i0.ɵɵFactoryTarget.Injectable }); }
