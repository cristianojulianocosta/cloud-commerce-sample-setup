...
export class CartDetailsComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CartDetailsComponent, deps: [{ token: i1.ActiveCartFacade }, { token: i1.SelectiveCartFacade }, { token: i2.AuthService }, { token: i2.RoutingService }, { token: i3.CartConfigService }], target: i0.ɵɵFactoryTarget.Component }); }
