...
export declare class QuickOrderItemComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<QuickOrderItemComponent, "[cx-quick-order-item], cx-quick-order-item", never, { "entry": { "alias": "entry"; "required": false; }; "index": { "alias": "index"; "required": false; }; "loading": { "alias": "loading"; "required": false; }; }, {}, never, never, false, never>;
}
