...
export declare class QuickOrderFormComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<QuickOrderFormComponent, "cx-quick-order-form", never, { "limit": { "alias": "limit"; "required": false; }; }, {}, never, never, false, never>;
}
