...
export declare class CartEffects {
    ...
    protected handleLoadCartError(payload: any, error: any): Observable<CartActions.LoadCart> | Observable<CartActions.LoadCartFail> | Observable<CartActions.RemoveCart>;
