...
export declare class AppliedCouponsComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AppliedCouponsComponent, "cx-applied-coupons", never, { "vouchers": { "alias": "vouchers"; "required": false; }; "cartIsLoading": { "alias": "cartIsLoading"; "required": false; }; "isReadOnly": { "alias": "isReadOnly"; "required": false; }; }, {}, never, never, false, never>;
}
