...
export declare class CartItemValidationWarningComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CartItemValidationWarningComponent, "cx-cart-item-validation-warning", never, { "code": { "alias": "code"; "required": false; }; }, {}, never, never, false, never>;
}
