import { Address, CostCenter, Currency, PaymentDetails, PointOfService, Price, Principal, Product, Promotion } from '@spartacus/core';
 ...
 */
export declare enum AbstractOrderType {
    /**
     * Active cart
     */
    CART = "Cart",
