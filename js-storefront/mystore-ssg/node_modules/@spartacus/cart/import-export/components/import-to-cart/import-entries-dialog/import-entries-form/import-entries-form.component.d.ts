...
export declare class ImportEntriesFormComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ImportEntriesFormComponent, "cx-import-entries-form", never, { "type": { "alias": "type"; "required": false; }; }, { "submitEvent": "submitEvent"; }, never, never, false, never>;
}
