...
export declare class WishListItemComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<WishListItemComponent, "[cx-wish-list-item], cx-wish-list-item", never, { "isLoading": { "alias": "isLoading"; "required": false; }; "cartEntry": { "alias": "cartEntry"; "required": false; }; }, { "remove": "remove"; }, never, never, false, never>;
}
