...
import { LaunchDialogService, SiteContextComponentService } from '@spartacus/storefront';
...
export declare class SavedCartListComponent implements OnInit, OnDestroy {
    ...
    protected readonly siteContextService: SiteContextComponentService | null;
    ...
    protected observeAndReloadSavedCartOnContextChange(): void;
    ngOnDestroy(): void;
