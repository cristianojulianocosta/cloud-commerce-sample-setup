...
import { LogoutEvent, LoginEvent, UrlModule, I18nModule, provideDefaultConfig, useFeatureStyles, FeaturesConfigModule } from '@spartacus/core';
...
class CheckoutReplenishmentFormService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutReplenishmentFormService, deps: [{ token: i2.EventService }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.OrderFacade }, { type: i2.RoutingService }, { type: i3.UntypedFormBuilder }, { type: i4.LaunchDialogService }, { type: i0.ViewContainerRef }, { type: CheckoutReplenishmentFormService }, { type: i1.ScheduledReplenishmentOrderFacade }] });
...
class CheckoutScheduledReplenishmentPlaceOrderModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderModule, declarations: [CheckoutScheduledReplenishmentPlaceOrderComponent], imports: [AtMessageModule,
            CommonModule,
            RouterModule,
            UrlModule,
            I18nModule,
            ReactiveFormsModule], exports: [CheckoutScheduledReplenishmentPlaceOrderComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        AtMessageModule,
...
class CheckoutScheduleReplenishmentOrderModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduleReplenishmentOrderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduleReplenishmentOrderModule, declarations: [CheckoutScheduleReplenishmentOrderComponent], imports: [CommonModule,
            RouterModule,
            I18nModule,
            IconModule,
            FeaturesConfigModule], exports: [CheckoutScheduleReplenishmentOrderComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduleReplenishmentOrderModule, providers: [
            provideDefaultConfig({
                cmsComponents: {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduleReplenishmentOrderModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class CheckoutScheduledReplenishmentComponentsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentComponentsModule, imports: [CommonModule,
            CheckoutScheduleReplenishmentOrderModule,
            CheckoutScheduledReplenishmentPlaceOrderModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentComponentsModule, imports: [CommonModule,
            CheckoutScheduleReplenishmentOrderModule,
            CheckoutScheduledReplenishmentPlaceOrderModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: CheckoutScheduledReplenishmentComponentsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
