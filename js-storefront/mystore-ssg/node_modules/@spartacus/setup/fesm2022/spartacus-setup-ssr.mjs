...
class ExpressLoggerService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: ExpressLoggerService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: ExpressLoggerService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: ExpressLoggerService, decorators: [{
            type: Injectable,
...
export { DefaultExpressServerLogger, EXPRESS_SERVER_LOGGER, ExpressLoggerService, NgExpressEngineDecorator, OptimizedSsrEngine, PrerenderingLoggerService, REQUEST, RESPONSE, RenderingCache, RenderingStrategy, defaultRenderingStrategyResolver, defaultRenderingStrategyResolverOptions, defaultSsrOptimizationOptions, getDefaultRenderKey, getRequestContext, getServerRequestProviders, ngExpressEngine, provideServer, serverLoggerServiceFactory };
