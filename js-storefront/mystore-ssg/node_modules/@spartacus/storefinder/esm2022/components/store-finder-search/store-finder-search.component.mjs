...
export class StoreFinderSearchComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: StoreFinderSearchComponent, deps: [{ token: i1.RoutingService }], target: i0.ɵɵFactoryTarget.Component }); }
