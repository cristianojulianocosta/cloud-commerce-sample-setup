...
export declare class StoreFinderStoreComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StoreFinderStoreComponent, "cx-store-finder-store", never, { "location": { "alias": "location"; "required": false; }; "disableMap": { "alias": "disableMap"; "required": false; }; }, {}, never, never, false, never>;
}
