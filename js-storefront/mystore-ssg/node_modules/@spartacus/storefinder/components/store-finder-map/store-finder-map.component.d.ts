...
export declare class StoreFinderMapComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StoreFinderMapComponent, "cx-store-finder-map", never, { "locations": { "alias": "locations"; "required": false; }; }, { "selectedStoreItem": "selectedStoreItem"; }, never, never, false, never>;
}
