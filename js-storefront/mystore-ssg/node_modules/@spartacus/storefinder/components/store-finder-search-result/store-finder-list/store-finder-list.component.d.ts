...
export declare class StoreFinderListComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StoreFinderListComponent, "cx-store-finder-list", never, { "locations": { "alias": "locations"; "required": false; }; "useMylocation": { "alias": "useMylocation"; "required": false; }; }, {}, never, never, false, never>;
}
