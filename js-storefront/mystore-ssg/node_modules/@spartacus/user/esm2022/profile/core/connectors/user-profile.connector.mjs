...
export class UserProfileConnector {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: UserProfileConnector, deps: [{ token: i1.UserProfileAdapter }], target: i0.ɵɵFactoryTarget.Injectable }); }
