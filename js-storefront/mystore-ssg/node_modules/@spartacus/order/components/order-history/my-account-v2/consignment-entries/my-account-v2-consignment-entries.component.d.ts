...
export declare class MyAccountV2ConsignmentEntriesComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MyAccountV2ConsignmentEntriesComponent, "cx-my-account-v2-consignment-entries", never, { "consignments": { "alias": "consignments"; "required": false; }; "orderCode": { "alias": "orderCode"; "required": false; }; }, {}, never, never, false, never>;
}
