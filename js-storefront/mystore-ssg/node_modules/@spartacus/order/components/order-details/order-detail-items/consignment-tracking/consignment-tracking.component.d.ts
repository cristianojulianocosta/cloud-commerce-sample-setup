...
export declare class ConsignmentTrackingComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConsignmentTrackingComponent, "cx-consignment-tracking", never, { "consignment": { "alias": "consignment"; "required": false; }; "orderCode": { "alias": "orderCode"; "required": false; }; }, {}, never, never, false, never>;
}
