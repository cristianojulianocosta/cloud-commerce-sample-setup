...
export declare class CancelOrReturnItemsComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CancelOrReturnItemsComponent, "cx-amend-order-items", never, { "entries": { "alias": "entries"; "required": false; }; "isConfirmation": { "alias": "isConfirmation"; "required": false; }; }, {}, never, never, false, never>;
}
