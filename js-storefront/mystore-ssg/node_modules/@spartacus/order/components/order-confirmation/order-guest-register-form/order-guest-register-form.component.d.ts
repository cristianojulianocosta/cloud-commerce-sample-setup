...
export declare class OrderGuestRegisterFormComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OrderGuestRegisterFormComponent, "cx-guest-register-form", never, { "guid": { "alias": "guid"; "required": false; }; "email": { "alias": "email"; "required": false; }; }, {}, never, never, false, never>;
}
