...
import { AbstractOrderType, CartOutlets, DeliveryMode, OrderEntry } from '@spartacus/cart/base/root';
...
export declare class OrderConfirmationShippingComponent implements OnInit, OnDestroy {
    ...
    readonly abstractOrderType: typeof AbstractOrderType;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OrderConfirmationShippingComponent, "cx-order-confirmation-shipping", never, { "showItemList": { "alias": "showItemList"; "required": false; }; }, {}, never, never, false, never>;
}
