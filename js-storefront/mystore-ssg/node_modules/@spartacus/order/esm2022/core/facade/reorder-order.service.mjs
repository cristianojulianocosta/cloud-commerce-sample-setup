...
export class ReorderOrderService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: ReorderOrderService, deps: [{ token: i1.CommandService }, { token: i2.ReorderOrderConnector }, { token: i1.UserIdService }, { token: i3.ActiveCartFacade }, { token: i3.MultiCartFacade }], target: i0.ɵɵFactoryTarget.Injectable }); }
