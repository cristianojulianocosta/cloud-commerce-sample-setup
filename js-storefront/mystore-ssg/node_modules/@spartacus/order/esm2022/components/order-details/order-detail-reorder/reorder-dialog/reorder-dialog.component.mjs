...
export class ReorderDialogComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: ReorderDialogComponent, deps: [{ token: i1.LaunchDialogService }, { token: i2.ReorderOrderFacade }, { token: i3.MultiCartFacade }], target: i0.ɵɵFactoryTarget.Component }); }
