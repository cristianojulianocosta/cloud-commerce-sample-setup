...
export class OrderHistoryComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: OrderHistoryComponent, deps: [{ token: i1.RoutingService }, { token: i2.OrderHistoryFacade }, { token: i1.TranslationService }, { token: i2.ReplenishmentOrderHistoryFacade }], target: i0.ɵɵFactoryTarget.Component }); }
