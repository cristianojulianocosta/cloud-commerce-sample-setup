...
class PDFInvoicesConnector {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: PDFInvoicesConnector, deps: [{ token: PDFInvoicesAdapter }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: PDFInvoicesConnector, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: PDFInvoicesConnector, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class PDFInvoicesService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: PDFInvoicesService, deps: [{ token: i1.RoutingService }, { token: i1.UserIdService }, { token: PDFInvoicesConnector }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
class PDFInvoicesCoreModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: PDFInvoicesCoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.0.5", ngImport: i0, type: PDFInvoicesCoreModule }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: PDFInvoicesCoreModule, providers: [
            PDFInvoicesService,
            {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: PDFInvoicesCoreModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [],
                    providers: [
