...
export class AsmCreateCustomerFormComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmCreateCustomerFormComponent, deps: [{ token: i1.LaunchDialogService }, { token: i2.FormBuilder }, { token: i3.AsmCreateCustomerFacade }, { token: i4.TranslationService }], target: i0.ɵɵFactoryTarget.Component }); }
