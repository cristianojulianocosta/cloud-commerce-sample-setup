...
export class AsmCustomerListService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmCustomerListService, deps: [{ token: i1.QueryService }, { token: i2.AsmConnector }, { token: i3.Store }], target: i0.ɵɵFactoryTarget.Injectable }); }
