...
export class AsmService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmService, deps: [{ token: i1.Store }], target: i0.ɵɵFactoryTarget.Injectable }); }
