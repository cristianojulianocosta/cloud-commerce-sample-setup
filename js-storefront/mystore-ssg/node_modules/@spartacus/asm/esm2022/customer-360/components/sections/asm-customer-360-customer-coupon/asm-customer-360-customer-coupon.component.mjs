...
export class AsmCustomer360CustomerCouponComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmCustomer360CustomerCouponComponent, deps: [{ token: i1.AsmCustomer360SectionContext }, { token: i2.AsmCustomer360Facade }, { token: i3.CustomerCouponService }], target: i0.ɵɵFactoryTarget.Component }); }
