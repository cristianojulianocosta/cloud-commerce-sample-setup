...
export class AsmCustomer360SupportTicketsComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmCustomer360SupportTicketsComponent, deps: [{ token: i1.AsmCustomer360SectionContext }], target: i0.ɵɵFactoryTarget.Component }); }
