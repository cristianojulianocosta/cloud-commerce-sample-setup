...
export class AsmCustomer360TableComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmCustomer360TableComponent, deps: [{ token: i1.AsmCustomer360Config }, { token: i2.DirectionService }], target: i0.ɵɵFactoryTarget.Component }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmCustomer360TableComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.AsmCustomer360Config }, { type: i2.DirectionService }], propDecorators: { table: [{
                type: ViewChild,
                args: ['table']
            }], columns: [{
                type: Input
