...
export class AsmCustomer360ActiveCartComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmCustomer360ActiveCartComponent, deps: [{ token: i1.AsmCustomer360SectionContext }, { token: i2.ProductService }], target: i0.ɵɵFactoryTarget.Component }); }
