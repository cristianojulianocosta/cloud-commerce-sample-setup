...
export class AsmDeepLinkService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.5", ngImport: i0, type: AsmDeepLinkService, deps: [{ token: i1.RoutingService }, { token: i1.WindowRef }, { token: i2.AsmEnablerService }], target: i0.ɵɵFactoryTarget.Injectable }); }
