...
export declare class AsmCustomer360SectionComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AsmCustomer360SectionComponent, "cx-asm-customer-360-section", never, { "component": { "alias": "component"; "required": false; }; "customer": { "alias": "customer"; "required": false; }; "config": { "alias": "config"; "required": false; }; "data": { "alias": "data"; "required": false; }; }, { "navigate": "navigate"; }, never, never, false, never>;
}
