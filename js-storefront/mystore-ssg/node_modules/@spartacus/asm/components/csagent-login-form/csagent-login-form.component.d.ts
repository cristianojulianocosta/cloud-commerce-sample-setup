...
export declare class CSAgentLoginFormComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CSAgentLoginFormComponent, "cx-csagent-login-form", never, { "csAgentTokenLoading": { "alias": "csAgentTokenLoading"; "required": false; }; }, { "submitEvent": "submitEvent"; }, never, never, false, never>;
}
