...
function loadEsmModule(modulePath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Function('modulePath', "return import(modulePath);")(modulePath)];
                case 1:
                    namespaceObject = _a.sent();
                    // If it is not ESM then the values needed will be stored in the `default` property.
                    // TODO_ESM: This can be removed once `@angular/*` packages are ESM only.
                    if (namespaceObject.default) {
                        return [2 /*return*/, namespaceObject.default];
                    }
                    else {
                        return [2 /*return*/, namespaceObject];
                    }
                    return [2 /*return*/];
            }
        });
...
//# sourceMappingURL=load-esm-module.js.map